...
and no monkeypatched function whose behaviour depends on import order beyond this one.

Import this module before anything that resolves a robot by name: `src/soft_arm_program.py`
does, and the training launcher does it before importing ikflow. Idempotent, so importing
it twice (or from both places) is harmless.
"""

import jrl.robots

from src.soft_arm.robot import ROBOT_CLASSES
